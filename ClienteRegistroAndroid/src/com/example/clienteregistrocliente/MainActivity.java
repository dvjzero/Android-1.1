...
public class MainActivity extends Activity {
	...
	private static final String URL = "http://192.168.0.102:8080/ChileDenuncia/services/ServicioUsuario?wsdl";
	private String TAG = "Carlos";// para mostrar cosas en consola con ese tag
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				String mensaje = registroAdmin(etNombre.getText().toString(),
						etclave.getText().toString(),
						etciudad.getText().toString(), etsector.getText()
								.toString(), etmail.getText().toString());
				uno.setText(mensaje);
			}
		});
	}
	...
	public String registroAdmin(String usuario, String clave, String ciudad,
			String sector, String mail) {
